...
image::img_ch4_DIsoMLevel.drawio.png[]
...
[caption="Figure {counter:image}: ", reftext="Figure {image}"]
[title= "Domain Isolation at non-M-level"]
image::img_ch4_DIsoMultPrivLevel.drawio.png[]

[caption="Figure {counter:image}: ", reftext="Figure {image}"]
[title= "Domain Isolation at System Level"]
image::img_ch4_DIsoSysLevel.drawio.png[]
